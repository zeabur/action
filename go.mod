module github.com/zeabur/action
...
require (
	...
	github.com/containerd/nydus-snapshotter v0.13.5 // indirect
	...
	github.com/tonistiigi/fsutil v0.0.0-20240126004732-c40226105f0b // indirect
